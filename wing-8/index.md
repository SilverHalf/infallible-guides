...
[Stacking Sigils](../general.html#stacking-sigils) are viable, and can be prepared by killing the enemies between the entrance to the wing and [Camp](https://wiki.guildwars2.com/wiki/Mount_Balrior#Cleanse_the_camp).
...
One <img class='inline mesmer'> [Mesmer] or <img class='inline thief'> [Thief] should pre-position next to the challenge mote at Decima's arena beforehand.

Begin the event with mount skills such as <img class='inline leap'> [Leap] and <img class='inline roll-out'> [Roll Out]. Strip <img class='inline resolution'> [Resolution] from the [Conduit](https://wiki.guildwars2.com/wiki/Mount_Balrior#Legendary_Sentient_Conduit) and burst it down. The <img class='inline mesmer'> [Mesmer] or <img class='inline thief'> [Thief] will prepare a <img class='inline portal'> <img class='inline shadow-portal'> portal as soon as the encounter begins, then join the rest of the squad. Open the portal when the miniboss is close to dying and hit the Challenge Mote as soon as possible once the event is complete.
...
<img class='center' width='80%' src='./decima/decima_1.webp'>
...
<img class='center' width='80%' src='./decima/decima_2.webp'>
...
- <img class='inline august-queen'> [Tale of the August Queen] is very strong on the melee group as it completely negates the [Spreads]. Save it for when they overlap with the [Green Arrow](https://silverhalf.github.io/mount-balrior/decima/mechanics.html#focused-fluxlance).
...
To combat this issue, the *bubble* is almost always played by a third healer, often a <img class='inline luminary'> [Luminary] or <img class='inline vindicator'> [Vindicator]. This is less of a DPS loss than one may expect, as boonDPS bubbles often have to make quite a few compromises in build and gameplay to fulfill their role.

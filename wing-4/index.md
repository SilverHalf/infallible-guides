---
title: 4. Bastion of the Penitent
layout: page
nav_order: 4
parent: Guides
---
...
| **Timer Start** |  On speaking to <img class='inline glenna'> [Glenna] after first entering the wing. |
...
- A strong celestial healer will make life much better for your group. Common choices are <img class='inline specter'> [Specter] and <img class='inline troubadour'> [Troubadour].
- (Boon)DPS classes with some passive healing such as <img class='inline specter'> [Specter], <img class='inline luminary'> [Luminary], <img class='inline scourge'> [Scourge] and <img class='inline ritualist'> [Ritualist] are extremely useful for supporting the off-heal subgroup.
...
#### Mursaat Overseer
{: .no_toc}
- Since damage pressure is extremely low, you can run with no healers at all provided the squad has some form of passive health regeneration or barrier from classes such as <img class='inline specter'> [Specter], <img class='inline luminary'> [Luminary], <img class='inline scourge'> [Scourge] or <img class='inline ritualist'> [Ritualist].
...
- Celestial <img class='inline troubadour'> [Troubadour] is a common healer due to its easy access to <img class='inline aegis'> [Aegis] with <img class='inline rogue'> [Tale of the Honorable Rogue](https://wiki.guildwars2.com/wiki/Tale_of_the_Honorable_Rogue). Similarly, most <img class='inline guardian'> [Guardians] can slot in <img class='inline advance'> ["Advance!"] at little to no cost.
- <img class='inline ritualist'> [Ritualist] deserves a mention for its excellent utility: <img class=inline src='https://wiki.guildwars2.com/images/thumb/7/7b/Innervate_Preservation.png/72px-Innervate_Preservation.png'> [Innervate Preservation](https://wiki.guildwars2.com/wiki/Innervate_Preservation) and <img class='inline' src='https://wiki.guildwars2.com/images/thumb/3/37/Weapon_of_Warding.png/72px-Weapon_of_Warding.png'> [Weapon of Warding](https://wiki.guildwars2.com/wiki/Weapon_of_Warding) are instant-cast sources of group <img class='inline aegis'> [Aegis]. <img class='inline' src='https://wiki.guildwars2.com/images/thumb/3/37/Weapon_of_Warding.png/72px-Weapon_of_Warding.png'> [Weapon of Warding](https://wiki.guildwars2.com/wiki/Weapon_of_Warding) can also be combined with <img class='inline' src='https://wiki.guildwars2.com/images/thumb/0/05/Wielder%27s_Boon.png/38px-Wielder%27s_Boon.png'> [Wielder's Boon](https://wiki.guildwars2.com/wiki/Wielder%27s_Boon) to give multiple stacks of pseudo-Aegis for very safe [Mind Crushes](https://wiki.guildwars2.com/wiki/Mind_Crush).
...
The timer for <img class='inline achievement'> <a class='yellow-text' href='./404.html'>Down and Out</a> begins upon talking with Glenna on first entering the wing. Glenna will then start walking towards the platform, with the boss spawning in when she gets into position. This cannot be sped up in any way, shape or form: it will always take 47 seconds from when the timer starts to when the boss becomes vulnerable. Players should take advantage of this time to check their builds and preposition on the platform.


{: .warning}
<img class='inline achievement'> <a class='yellow-text' href='../general.html#achievement-details'>Down and Out</a> is not re-applied if you talk to Glenna a second time after resetting the boss: if you wipe on Cairn, you will have to swap to a fresh instance.

---

### Skipping Greens

One of the main mechanics that groups can optimize on Cairn is [Spatial Manipulation], a.k.a. greens. A player that fails this mechanic by not being in the green when it pops will <img class='inline float'> [Float] and gain 25 stacks of <img class='inline' src='https://wiki.guildwars2.com/images/thumb/b/b9/Unseen_Burden.png/30px-Unseen_Burden.png'> [Unseen Burden](https://wiki.guildwars2.com/wiki/Unseen_Burden). 

This debuff is not an issue until it reaches 99 stacks: groups will therefore provide <img class='inline stability'> [Stability] during the greens, thus preventing the <img class='inline float'> [Float] effect while maintaining high DPS uptime on the boss. Players can generally tank only one green per pull, as the second one will petrify them.

High DPS groups will only see two greens: the initial one as the fight starts and a second one after 50%. In this case, it's best to play the first green correctly (or ignore it with <img class='inline invuln'> [Invulnerability] as explained in [the following section](#skipping-special-action-key)), as its pattern includes a safe zone next to the boss. <img class='inline stability'> [Stability] can then be used to skip the second green.

<img class=center width='70%' src='./cairn/cairn_1.svg'>
<img class=center width='70%' src='./cairn/cairn_2.svg'>

Most groups will see three greens in total, in which case you should play the first and second green, skipping the third. This is due to the second green likely spawning before 50%, thus its patterns having safe zones closer to the middle than the third.
...
The <img class='inline mesmer'> [Mesmer] should be ready for when the portal opens. They should then use all their mobility to get to the rubble pile, prepare <img class='inline portal'> [Portal Entre], run to the shovel and open their portal next to it.

In the meanwhile, the rest of the squad should be running through the ruins to the door. One person should speak to <img class='inline glenna'> [Glenna] on the way. Designate four more people besides the <img class='inline mesmer'> [Mesmer] to take the portal, pick up a shovel, take the portal back and use it on the rubble pile.
...
Start by running in to position *1*, baiting the first spear there. The tank should then move in between *1* and *8*, while the rest of the squad can move to position *2* or *3*. Remain at maximum melee range while doing damage, baiting the spear as far from the boss as possible. This gives you more space to work with overall, and reduces the risk of the tank being caught inside a spear during CC.
</div>
<div class='center adapt-width'>
<img class='center' src='./samarog/samarog_1.webp'>
</div>
</div>

<div class="row-container">
<div class='center adapt-width'>
<img class='center' src='./samarog/samarog_2.webp'>
</div>
<div class='adapt-width-50' markdown=block>
When the first friends mechanic occurs, move to the other side. Then, on the next one, move towards position *8*, and finally to *4* once you reach 33% and the split phase begins. Try to get to *4* quickly: if [Rigom] aggros onto a player who is stuck doing friends far from the alcove, your split phase will become noticeably slower.
</div>
</div>

<div class="row-container">
<div class='adapt-width-50' markdown=block>
While on 4, you should be <img class='inline pull'> pulling [Rigom] into Samarog's hitbox. This is best done using a combination of two or more skills to push him deep into the alcove, otherwise you risk him running out and exploding while on stack. An example would be combining <img class='inline curtain'> [Temporal Curtain] with <img class='inline illusionary-wave'> [Illusionary Wave] or another <img class='inline knockback'> [Knockback].
</div>
<div class='center adapt-width'>
<img class='center' src='./samarog/samarog_3.webp'>
</div>
</div>
...
<div class='adapt-width-50' markdown=block>
Once you get the friends mechanic on *4*, you can move to *5*, and then to *6* if you get it a second time. Ideally you should not get it a third time. Once [Guldhelm] dies, you should then <img class='inline pull'> pull [Rigom] out and kill him quickly, beginning the next main phase.
</div>
</div>
...
Be ready to adapt to new positions on the fly: if the boss is slightly mispositioned or a spear spawns where it shouldn't, call out a new location and have the squad move there.
...
[Guardians]: https://wiki.guildwars2.com/wiki/Guardian
